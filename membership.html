...
<body>
    <header>
        <a href="index.html" class="nav-branding nav-php-logo"><img src="./images/hockeylogo.png" width="160px" height="60px"></a></li>
        <nav class="navbar">
            <ul class="nav-menu">
    ...
    <div id="membership-content">
        ...
        <div class="form">
            <form action="processData.php" method="post">
                ...
                <input type="number" id="age" name="age" required min="5" max="18" required>
                <br><br>
        
                <label>Coaching Package:</label>
                <br><br>
                <input type="radio" id="premiumPackage" name="coachingPackage" value="premium" checked>
                <label for="premiumPackage">Premium Coaching Package ($369.99) </label> <br> <br>
                ...
                <label for="standardPackage">Standard Coaching Package ($219.99) </label> <br> <br>
                ...
                <br>
                <input class="membership-submit" type="submit" value="Submit">
            </form>
        </div>
        <h3 style="margin-top: 4vh; text-align: center; color: black"> Payments are due once placement is confirmed after tryouts </h3>
    </div>
    <footer>
